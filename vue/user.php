...
<?php include('header.inc.php'); ?>
    ...
    <section class="container-infos-user">
    	<h2 class="text-center"><i class="fa fa-exclamation-triangle" aria-hidden="true"> </i> Modifiez les champs que vous voulez mettre à jour <br><small>Mot de passe actuel est obligatoire</small></h2>
